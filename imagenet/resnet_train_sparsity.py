...
tf.app.flags.DEFINE_string('train_dir', '/tmp/imagenet_sparsity_train',
...
def main(argv=None):  # pylint: disable=unused-argument
  ...
  if tf.io.gfile.exists(FLAGS.sparsity_dir):
    tf.io.gfile.rmtree(FLAGS.sparsity_dir)
  tf.io.gfile.makedirs(FLAGS.sparsity_dir)
  train()
